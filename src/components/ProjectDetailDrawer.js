...
const textSegment = (content) => ({ kind: 'text', content });
const linkSegment = (label, targetId) => ({ kind: 'link', label, targetId });
const JOJO_DIALOGUE = {
    'cap-money': [
        [
            textSegment('Cap is creating a new way to get stablecoin yield by using EigenLayer security with an autonomous layer of operators to capture the best yield at any moment, regardless of market conditions.')
        ],
        [
            textSegment('This fixes a common problem with yield-bearing stablecoins: their strategies only offer good yields when optimal conditions are met. Cap automatically pivots its strategy depending on conditions, making it a very strong actor in the space.')
        ]
    ],
    euphoria: [
        [
            textSegment('Euphoria is the most addictive mobile-first trading app in the ecosystem. It leverages MegaETH scalability and RedStone\'s optimized oracle to deliver fast trading, coupled with tap trading, a completely new way to abstract the worst parts of the trading experience while making it fun and addictive.')
        ],
        [textSegment('Definitely one of my favorites.')]
    ],
    rocket: [
        [
            textSegment('Rocket is redefining prediction markets with redistribution markets. Instead of keeping capital idle until long-term resolution, everyone wins or loses a portion of their bet every 5 seconds.')
        ],
        [
            textSegment('This, coupled with margin on every bet, creates high capital efficiency and a real-time prediction market that constantly adjusts. Even if Trump tweets something dumb and makes you lose your bet at the last minute, you would still have made a lot of money on Rocket by being directionally right, unlike on Polymarket. That\'s one of my favorites tbh.')
        ]
    ],
    aveforge: [
        [
            textSegment('Built by a team that has shipped Bloomtown and Graveyard Keeper on Steam, this addictive battler game is creating a strong IP around Mecha, using blockchain as settlement for rewards and cosmetics.')
        ],
        [textSegment("Definitely the gaming app I\'m the most excited about, I love every boss design.")]
    ],
    'hello-trade': [
        [
            textSegment('Mobile-first trading app built by ex-BlackRock (yes, the team that made IBIT possible), HelloTrade focuses on bringing TradFi assets onchain, such as stocks, RWAs, ETFs, and commodities.')
        ],
        [
            textSegment('I\'m genuinely excited about this one: the team is top-tier, they\'ve raised significant funding, and they\'re targeting a still untouched area of crypto adoption, using blockchain as a 24/7 settlement layer to trade anything at the speed of light on mobile.')
        ]
    ],
    'bad-bunnz': [
        [
    ...
    legend: [
        [
            textSegment('Still not sure this one will launch on MegaETH, as it was incubated by GTE, which is moving to its own L1. It\'s still a solid PvP trading project that deserves to be highlighted.')
        ],
        [textSegment('Would just love to get a bit of an update please.')]
    ],
    brix: [
        [
            textSegment('Brix is the first app bringing emerging markets onchain. While everyone is focusing on classic TradFi assets to earn 4% APR, Brix is doing the hard work of tokenizing emerging markets that can offer exposure of up to 40% APR.')
        ],
    ...
    dorado: [
        [
            textSegment("Fully trustless gambling app, leveraging blockchain to create a truly fair onchain casino. I\'m not sure I fully get how it will work with LPs, but it\'s clearly experimenting with something new, and I love the innovation.")
        ]
    ],
    pumpparty: [
        [
            textSegment("A social app that uses AI to clone personalities and trade. I\'m not sure if it\'s still alive, they haven\'t been communicating, but it had some hype a few months ago, so I\'ll keep an eye on it.")
        ]
    ],
    worldmarkets: [
        [
            textSegment('WCM is an all-in-one platform combining perps, spot, and lending on the same margin for maximum capital efficiency.')
        ],
        [textSegment('The only limit is your imagination, definitely one of the best apps imo.')]
    ],
    benchmark: [
        [
            textSegment("It\'s the curation layer for USDm and beyond, the actor that finds the best risk-reward strategies for protocols or institutions.")
        ],
        [textSegment("You\'re probably not the PMF here, but this is typically a sign of a mature ecosystem.")]
    ],
    avon: [
        [
            textSegment('Imagine if lending offers worked like trading orders, with personalized risk, LTV, rates, and more. That\'s exactly what Avon is doing by using a CLOB with isolated markets, creating a real-time, dynamic market for lending rates.')
        ],
    ...
    blackhaven: [
        [
            textSegment("By the crazy mind behind OlympusDAO, the one who created those insane flywheels back in the day. He\'s back, this time on the best blockchain to build an onchain DAT, like MicroStrategy, but faster, crazier, stronger, and for $MEGA.")
        ],
        [textSegment("Definitely something I\'ll love to follow.")]
    ],
    aqua: [
        [
            textSegment('Aqua could be your go-to LST, letting you hold OMEGA, which receives yield from $MEGA staking, and additionally uses the Tide and Current model to offer extra yield with a strong risk-reward ratio.')
        ]
    ],
    showdown: [
        [
            textSegment("The biggest card game on MegaETH, built by a Magic and Hearthstone card champion, with its own set of cards and rules. I\'m not a card player, more of a chess player, but I recognize talent, and this game has a lot of it, with an already strong community.")
        ]
    ],
    topstrike: [
        [
            textSegment('The only football trading game on MegaETH as far as I know, focused on mobile and adjusting in real time to match events.')
        ],
    ...
    kumbaya: [
        [
            textSegment('Definitely one of the main actors of the ecosystem and one of the biggest MegaMafia projects, building what will probably be the next big DEX and a launchpad expected to create and monetize cults.')
        ],
    ...
    'mega-heroes': [
        [
            textSegment("Trading app using AI and NFTs for copy trading and PvP. I thought the project was dead, then they came back. I don\'t know much about this one tbh, dyor, nfa, blablabla.")
        ]
    ],
    everwatch: [
        [
