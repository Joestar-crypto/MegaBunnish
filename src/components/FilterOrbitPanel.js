...
export const FilterOrbitPanel = ({ isInteracting = false }) => {
    ...
    return (_jsxs("div", { className: `filter-stack ${isInteracting ? 'filter-stack--hidden' : ''}`, children: [_jsx("div", { className: "trait-menu", role: "group", "aria-label": "Signal traits", children: SPECIAL_FILTERS.map(({ key, label, hint, Icon, iconSrc }) => (_jsxs("button", { type: "button", className: filters[key] ? 'chip chip--trait active' : 'chip chip--trait', onClick: () => toggleFilter(key), "aria-pressed": filters[key], children: [_jsx("span", { className: "chip__leading-icon", children: iconSrc ? _jsx("img", { src: iconSrc, alt: "", "aria-hidden": true }) : Icon ? _jsx(Icon, {}) : null }), _jsxs("span", { className: "chip__stack", children: [_jsx("span", { className: "chip-label", children: label }), hint ? _jsx("span", { className: "chip-hint", children: hint }) : null] })] }, key))) }), _jsxs("aside", { className: "category-rail", "aria-label": "Categories", children: [_jsx("p", { className: "category-rail__section-heading", children: "Sectors" }), _jsxs("div", { className: "category-rail__list", role: "tablist", children: [_jsxs("button", { className: activeCategory === null ? 'chip chip--category active' : 'chip chip--category', type: "button", onClick: () => quickSelect(null), "aria-pressed": activeCategory === null, children: [_jsx("span", { className: "chip-label", children: "All" }), _jsx("span", { className: "chip-count", children: totalProjects })] }), categories.map((category) => {
