...
function isAuthorized(request) {
    ...
    var querySecret = (_a = request.query) === null || _a === void 0 ? void 0 : _a.secret;
    var normalizedQuerySecret = Array.isArray(querySecret) ? querySecret[0] : querySecret;
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    response.status(500).json({
                        error: error_1 instanceof Error ? error_1.message : 'Unable to send event alerts.'
                    });
                    return [3 /*break*/, 4];
